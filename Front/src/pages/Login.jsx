...
function Login() {
  ...
  return (
    <div className="max-w-md w-2/6 p-6 bg-white bg-opacity-75 rounded-lg shadow-md">
      ...
      <form onSubmit={formik.handleSubmit} className="mt-4">
        ...
        <div className="mb-4">
          ...
          <input
            ...
            onChange={formik.handleChange}
            onBlur={formik.handleBlur}
            className="w-full p-3 border text-black rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
          />
